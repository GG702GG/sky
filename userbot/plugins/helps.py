...
async def _(event):
    ...
    if input_str == "م2":
        ...
        if r == 0:
            await event.edit(
                "𓆰 SOURCE SKY - COMMANDS 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧSKYⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n **☆:↫ قائـمه اوامر التسليه :** \n☆:↫ `.قمر` \n☆:↫ `.اقمار` \n☆:↫ `.قمور` \n☆:↫ `.قلوب` \n☆:↫ `.قلب ` \n☆:↫ `.جيم` \n☆:↫ `.افكر` \n☆:↫ `.افكرر` \n☆:↫ `.شنوو ` \n☆:↫ `.مح ` \n☆:↫ `.متت ` \n☆:↫ `.النضام الشمسي ` \n☆:↫ `.موسيقى ` \n☆:↫ `.قنبله ` \n☆:↫ `.مكبعات ` \n☆:↫ `.افعى ` \n☆:↫ `.طائره ` \n☆:↫ `.نجمه ` \n☆:↫ `.دائره ` \n☆:↫ `.شرطه ` \n☆:↫ `.فايروس ` \n☆:↫ `.غبي ` \n☆:↫ `.العد التنازلي`\n☆:↫ `.يد`\n☆:↫ `.تهكير`\n☆:↫ `.قرد `\n☆:↫ `.بشره `\n☆:↫ `.انيم `\n☆:↫ `.نيكول `\n☆:↫ `.مربع`\n☆:↫ `.قاتل `\n☆:↫ `.تحميل`\n☆:↫ `.رجل `\n☆:↫ `.شنوو `\n☆:↫ `.ريبي `\n☆:↫ `.تفريغ `\n☆:↫ `.حلويات `\n☆:↫ `.فليم`\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧSKYⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n 𓆩SKY - [SOURCE SKY](t.me/https://t.me/CXRCX/342) 𓆪"
            )
        else:
            await event.edit(
                "𓆰 SOURCE SKY - COMMANDS 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧSKYⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n **☆:↫ قائـمه اوامر التسليه :** \n☆:↫ `.قمر` \n☆:↫ `.اقمار` \n☆:↫ `.قمور` \n☆:↫ `.قلوب` \n☆:↫ `.قلب ` \n☆:↫ `.جيم` \n☆:↫ `.افكر` \n☆:↫ `.افكرر` \n☆:↫ `.شنوو ` \n☆:↫ `.مح ` \n☆:↫ `.متت ` \n☆:↫ `.النضام الشمسي ` \n☆:↫ `.موسيقى ` \n☆:↫ `.قنبله ` \n☆:↫ `.مكبعات ` \n☆:↫ `.افعى ` \n☆:↫ `.طائره ` \n☆:↫ `.نجمه ` \n☆:↫ `.دائره ` \n☆:↫ `.شرطه ` \n☆:↫ `.فايروس ` \n☆:↫ `.غبي ` \n☆:↫ `.العد التنازلي`\n☆:↫ `.يد`\n☆:↫ `.تهكير`\n☆:↫ `.قرد `\n☆:↫ `.بشره `\n☆:↫ `.انيم `\n☆:↫ `.نيكول `\n☆:↫ `.مربع`\n☆:↫ `.قاتل `\n☆:↫ `.تحميل`\n☆:↫ `.رجل `\n☆:↫ `.شنوو `\n☆:↫ `.ريبي `\n☆:↫ `.تفريغ `\n☆:↫ `.حلويات `\n☆:↫ `.فليم`\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧSKYⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n 𓆩SKY - [SOURCE SKY](t.me/https://t.me/CXRCX/342) 𓆪"
...
async def _(event):
    ...
    if input_str == "م3":
        ...
        if r == 0:
            await event.edit(
                "𓆰 SOURCE SKY - COMMANDS 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧSKYⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n **☆:↫  قائـمه اوامر الترحيب + اوامر الساعه :** \n☆:↫ `.ترحيب ` \n☆:↫ `.مسح ترحيب ` \n☆:↫ `.الترحيب `\n☆:↫`.اوتونيم `\n☆:↫`.اوتوبايو `\n☆:↫`.اينداوتونيم `\n☆:↫`.ايندالبايو التلقائي `\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧSKYⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n 𓆩 `.الترحيب `\n - [SOURCE SKY](t.me/https://t.me/CXRCX/342) 𓆪"
            )
        else:
            await event.edit(
...
async def _(event):
    ...
    if input_str == "قناه السورس":
        ...
        if r == 0:
            await event.edit(
                "𓆰 SOURCE SKY -  Channel 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧSKYⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n ☆:↫رابط التصيب [SOURCE SKY](t.me/https://t.me/CXRCX/342) "
            )
        else:
            await event.edit(
                "𓆰 SOURCE SKY - Channel  𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧSKYⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n ☆:↫رابط التنصيب ↬ [SOURCE SKY](t.me/https://t.me/CXRCX/342) "
            )
